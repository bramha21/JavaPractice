package com.coding.challenge.hackerrank.java;
 ...
 * of decreasing score; if 2 or more players have the same score, sort those
 * players alphabetically by name. To do this, you must create a Checker class
 * that implements the Comparator interface, then write an int compare(Player a,
 * Player b) method implementing the Comparator.compare(T o1, T o2) method.
 * 
 * Input Format
 * 
 ...
 * Player names consist of lowercase English
 * letters.
 * 
 * Output Format
 * 
